        ...
        for event in longpoll.listen():
            if event.type == VkEventType.MESSAGE_NEW and event.to_me:
                ...
                if not self.status and command:
                    ...
                    self.status = 'run'
                    msg = (f'Приветствую, {self.params["name"]}\n'
                           f'Хочешь посмотреть анкеты из своего города\n'
                           f'и примерно твоего возраста для знакомства?\n'
                           f'"да/нет"')
                    ...
                    if not self.params['age']:
                        ...
                        msg = (f'Начинаем поиск\n'
                               ...
                               f'Для продолжения просмотра анкет "далее/f')
                        self.status = 'view'
